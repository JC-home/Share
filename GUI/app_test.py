    ...
    def plot2(self):
        ...
        if aufteilung == 'Frage 1':
            question_dict = {
                            ...
                            'PEP': {'question': 'Frage 9', 'labels': ['Nein', 'Ja', 'Wenn ja, findet Anwendung in Projekt'], 'y_axis' : [0, 1, 2], 'kind' : 'pie', 'y_label' : 'Teamgroesse','supertitle': 'Gibt es einen PEP?/ Kommunikation im Projekt?'},
                            'Struktur': {'question': 'Frage 13', 'labels': ['PL, TPL, SW-HW PL', 'PL, SW-HW PL', 'nur PL oder TPL', 'Programmmanager, PL, SW-HW','andere Rollen' ], 'y_axis' : [1, 2, 3, 4, 5], 'kind' : 'bar', 'y_label' : 'Teamgroesse', 'supertitle': 'Wie ist die Organisationsstruktur im Projekt (PL, TPL,SWPL, Programmmanager, etc)?'},
                            'Tools': {'question': 'Frage 14', 'labels': ['keine', 'MS Project', 'RPlan', 'Excel'], 'y_axis' : [1, 2, 3, 4], 'kind' : 'bar','y_label' : 'Teamgroesse', 'supertitle': 'Welche Tools wurden von PM genutzt? (Gibt es Schnittstellen von Tools?)'},
                            'Detailplanung': {'question': 'Frage 15', 'labels': ['Nein', 'Ja', 'Kundengetrieben', 'Ja, interne Vorgaben'], 'y_axis' : [0, 1, 2, 3], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Gibt es eine Detailplanung? (Wenn ja, wie umfangreich/detailiiert?)Wann plant ihr im Detail? Wie lange vor Meilenstein?' },
                            'Ressourcenplanung': {'question': 'Frage 18', 'labels': ['gar nicht', 'in MS Project geplant', 'in MS Project geplant und getrackt', 'in anderem Tool geplant', 'in anderem Tool geplant und getrackt'], 'y_axis' : [0, 1, 2, 3, 4], 'kind' : 'pie','y_label' : 'Teamgroesse', 'supertitle': 'Wo werden Resourcen geplant und getrackt?' },
                            ...
                            'Templates': {'question': 'Frage 26', 'labels': ['keine', 'Projektplaene', 'Termin- und Porjektplaene','Terminplan, Projektplan, PM Plan, Projekthandbuch', 'zahlreiche PM Dokumente'], 'y_axis' : [0,1, 2, 3, 4], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Dokumente fuer PM als Firmentemplates oder Projektverantwortung? (WP liste, gener. Terminplan..)' },
                            'Organisationsform': {'question': 'Frage 32', 'labels': ['Matrix', 'Linie', 'Matrix und Linie', 'Projektorga'], 'y_axis' : [0, 1, 2, 3], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Wie ist in dieser Firma PM organisatorisch aufgestellt (Linie, Matrix, etc)?' },
                            'PMO': {'question': 'Frage 33', 'labels': ['Nein', 'Ja, erstellen Templates und Porzesse', 'andere Funktion'], 'y_axis' : [0, 1 ,2], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Gibt es PMO?' },            
                            }
            ...
            question_dict = {
                            ...
                            'Schnittstelle OEM': {'question': 'Frage 12a', 'labels': ['keine', 'OEM Schnittstelle PM', 'OEM Schnittstelle', 'OEM Schnittstellen zu vielen'], 'y_axis' : [0, 1, 2, 3], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Gab es Schnittstellen (intern/extern OEM) die mitbetreut wurden? ' },
                            'Planung': {'question': 'Frage 15', 'labels': ['Nein', 'Ja', 'Kundengetrieben', 'Ja, interne Vorgaben'], 'y_axis' : [0, 1, 2, 3], 'kind' : 'pie', 'y_label' : 'Teamgroesse', 'supertitle': 'Gibt es eine Detailplanung? (Wenn ja, wie umfangreich/detailiiert?)Wann plant ihr im Detail? Wie lange vor Meilenstein?' },
