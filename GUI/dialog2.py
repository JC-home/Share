...
class Ui_Dialog2(object):
    ...
    def retranslateUi(self, Dialog2):
        ...
        self.comboBox2.setItemText(9, _translate("Dialog2", "Projektkunden"))
        self.comboBox2.setItemText(10, _translate("Dialog2", "Templates"))
        self.comboBox2.setItemText(11, _translate("Dialog2", "Organisationsform"))
        self.comboBox2.setItemText(12, _translate("Dialog2", "PMO"))
